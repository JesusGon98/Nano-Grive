"""MCP client: connects to MCP servers and wraps their tools as native nano_grive tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a nano_grive Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only nano_grive Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only nano_grive Tool."""
