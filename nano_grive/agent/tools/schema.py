"""JSON Schema fragment types: all subclass :class:`~nano_grive.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~nano_grive.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~nano_grive.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~nano_grive.agent.tools.base.Schema`.
...
from nano_grive.agent.tools.base import Schema
