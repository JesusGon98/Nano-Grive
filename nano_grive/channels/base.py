...
class BaseChannel(ABC):
    ...
    to integrate with the nano_grive message bus.
    """
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                from nano_grive.providers.transcription import OpenAITranscriptionProvider
                provider = OpenAITranscriptionProvider(api_key=self.transcription_api_key)
            else:
                from nano_grive.providers.transcription import GroqTranscriptionProvider
