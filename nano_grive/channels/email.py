...
from nano_grive.utils.helpers import safe_filename
...
class EmailChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        base_subject = self._last_subject_by_chat.get(to_addr, "nano_grive reply")
    ...
    def _reply_subject(self, base_subject: str) -> str:
        subject = (base_subject or "").strip() or "nano_grive reply"
