...
from nano_grive.config.paths import get_media_dir
from nano_grive.config.schema import Base
from nano_grive.security.network import validate_url_target
from nano_grive.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    def _normalize_telegram_command(content: str) -> str:
        """Map Telegram-safe command aliases back to canonical nano_grive commands."""
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm nano_grive.\n\n"
