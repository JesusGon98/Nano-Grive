...
from nano_grive import __logo__
...
class ThinkingSpinner:
    """Spinner that shows 'nano_grive is thinking...' with pause support."""

    def __init__(self, console: Console | None = None):
        c = console or _make_console()
        self._spinner = c.status("[dim]nano_grive is thinking...[/dim]", spinner="dots")
        self._active = False
