...
from nano_grive.providers.openai_responses import (
    consume_sdk_stream,
    convert_messages,
    convert_tools,
...
if TYPE_CHECKING:
    from nano_grive.providers.registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/JesusGon98/Nano-Grive",
    "X-OpenRouter-Title": "nano_grive",
