...
This directory contains built-in skills that extend nano-grive's capabilities.
...
When skills reference large local documentation or logs, prefer nano-grive's built-in
