...
from nano_grive.providers.base import LLMProvider, LLMResponse, ToolCallRequest
...
async def test_tick_notifies_when_evaluator_says_yes(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("nano_grive.utils.evaluator.evaluate_response", _eval_notify)
...
async def test_tick_suppresses_when_evaluator_says_no(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("nano_grive.utils.evaluator.evaluate_response", _eval_silent)
