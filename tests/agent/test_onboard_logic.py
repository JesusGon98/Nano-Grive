...
from nano_grive.cli import onboard as onboard_wizard

# Import functions to test
from nano_grive.cli.commands import _merge_missing_defaults
from nano_grive.cli.onboard import (
    _BACK_PRESSED,
...
class TestProviderChannelInfo:
    ...
    def test_get_provider_names_returns_dict(self):
        from nano_grive.cli.onboard import _get_provider_names
    ...
    def test_get_channel_names_returns_dict(self):
        from nano_grive.cli.onboard import _get_channel_names
    ...
    def test_get_provider_info_returns_valid_structure(self):
        from nano_grive.cli.onboard import _get_provider_info
