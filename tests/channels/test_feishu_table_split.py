...
table, allowing nano_grive to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from nano_grive.channels import feishu
...
from nano_grive.channels.feishu import FeishuChannel
