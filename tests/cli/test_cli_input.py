...
from nano_grive.cli import commands
from nano_grive.cli import stream as stream_mod
...
def mock_prompt_session():
    ...
    with patch("nano_grive.cli.commands._PROMPT_SESSION", mock_session), \
         patch("nano_grive.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("nano_grive.cli.commands.PromptSession") as MockSession, \
         patch("nano_grive.cli.commands.FileHistory") as MockHistory, \
...
async def test_print_interactive_progress_line_pauses_spinner_before_printing():
    ...
    with patch("nano_grive.cli.commands._print_interactive_line", side_effect=fake_print):
        thinking = stream_mod.ThinkingSpinner(console=mock_console)
        with thinking:
