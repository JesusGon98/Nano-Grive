...
from nano_grive.providers.base import GenerationSettings, LLMProvider, LLMResponse
...
async def test_chat_with_retry_retries_transient_error_then_succeeds(monkeypatch) -> None:
    ...
    monkeypatch.setattr("nano_grive.providers.base.asyncio.sleep", _fake_sleep)
