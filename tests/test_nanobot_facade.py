...
from nano_grive.nano_grive import Nanobot, RunResult
...
def test_from_config_default_path():
    ...
    with patch("nano_grive.config.loader.load_config") as mock_load, \
         patch("nano_grive.nano_grive._make_provider") as mock_prov:
...
def test_sdk_make_provider_uses_github_copilot_backend():
    from nano_grive.config.schema import Config
    from nano_grive.nano_grive import _make_provider
...
def test_import_from_top_level():
    from nano_grive import Nanobot as N, RunResult as R
    assert N is Nanobot
