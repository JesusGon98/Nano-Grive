...
from nano_grive.agent.tools.filesystem import (
    EditFileTool,
    ListDirTool,
    ReadFileTool,
    _find_match,
...
class TestWorkspaceRestriction:
    ...
    async def test_read_allowed_in_media_dir(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("nano_grive.agent.tools.filesystem.get_media_dir", lambda: media_dir)
    ...
    async def test_extra_dirs_does_not_widen_write(self, tmp_path):
        from nano_grive.agent.tools.filesystem import WriteFileTool
