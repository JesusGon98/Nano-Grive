...
from nano_grive.agent.tools.mcp import (
    MCPResourceWrapper,
    MCPPromptWrapper,
    MCPToolWrapper,
    connect_mcp_servers,
...
from nano_grive.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("nano_grive.agent.tools.mcp.logger.warning", _warning)
